...
ChannelConfigAfterReset = bitarray('10100100100000100000000001101100000000001111010011101111111000111101000000111000001110111101010100101010111110000000000000000')
...
class AsicChannelConfig(bitarray):
	...
	def __init__(self, initial=None, endian="big"):
		...
		self.setValue("fe_delay", 0b01101)

...
namespace PETSYS {
	...
	class WriteRawHelper: public OrderedEventHandler<RawHit, RawHit> {
	  ...
	  public:
		WriteRawHelper(DataFileWriter *dataFileWriter, EventSink<RawHit> *sink): OrderedEventHandler<RawHit, RawHit>(sink), dataFileWriter(dataFileWriter) {};
	...
	class WriteSinglesHelper: public OrderedEventHandler<Hit, Hit> {
	  private:
		DataFileWriter *dataFileWriter;
	  public:
		WriteSinglesHelper(DataFileWriter *dataFileWriter, EventSink<Hit> *sink): OrderedEventHandler<Hit, Hit>(sink), dataFileWriter(dataFileWriter) {};
	...
	class WriteGroupsHelper: public OrderedEventHandler<GammaPhoton, GammaPhoton> {
	  private:
		DataFileWriter *dataFileWriter;
	  public:
		WriteGroupsHelper(DataFileWriter *dataFileWriter, EventSink<GammaPhoton> *sink): OrderedEventHandler<GammaPhoton, GammaPhoton>(sink), dataFileWriter(dataFileWriter) {};
	...
	class WriteCoincidencesHelper: public OrderedEventHandler<Coincidence, Coincidence> {
	  private:
		DataFileWriter *dataFileWriter;
	  public:
		WriteCoincidencesHelper(DataFileWriter *dataFileWriter, EventSink<Coincidence> *sink): OrderedEventHandler<Coincidence, Coincidence>(sink), dataFileWriter(dataFileWriter) {};
